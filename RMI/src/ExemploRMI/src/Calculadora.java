...
public class Calculadora  implements ICalculadora {
	...
	public int sub(int a, int b) throws RemoteException {
		System.out.println("O total de chamadas " + chamadas++);
		System.out.println("Método subtração foi chamado " + chamadasSub++);
		return a - b;
	}
	
	public int mul(int a, int b) throws RemoteException {
		System.out.println("O total de chamadas " + chamadas++);
		System.out.println("Método multiplicação foi chamado " + chamadasMul++);
		return a * b;
	}
	
	public int div(int a, int b) throws RemoteException {
		System.out.println("O total de chamadas " + chamadas++);
		System.out.println("Método divisão foi chamado " + chamadasDiv++);
		return a / b;
	}
	
	public double exp(int a) throws RemoteException {
		System.out.println("O total de chamadas " + chamadas++);
		System.out.println("Método potenciação foi chamado " + chamadasPot++);
		return  Math.exp((double)a);
	}
	
	public int modulo(int a) throws RemoteException {
		System.out.println("O total de chamadas " + chamadas++);
		System.out.println("Método módulo foi chamado " + chamadasMod++);
		return Math.abs(a);
	}
